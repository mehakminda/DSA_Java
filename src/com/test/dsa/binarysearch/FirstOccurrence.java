...
public class FirstOccurrence {
	...
	public static void main(String[] args) {
		...
		System.out.println(firOccurrenceRecursive(arr,0,arr.length,5));
		System.out.println(firOccurrenceRecursive(arr,0,arr.length,88));
		System.out.println(firOccurrenceRecursive(arr,0,arr.length,23));
